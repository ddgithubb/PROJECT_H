...
export const HorizontalScrollViewManager = NativeModules.MvcpHorizontalScrollViewManager;
...
export default React.forwardRef(
  (
    ...
    const enableMvcp = () => {
      ...
      const enableMvcpPromise = HorizontalScrollViewManager.enableMaintainVisibleContentPosition(
        scrollableNode,
    ...
    const disableMvcp: () => Promise<void> = () => {
      if (!HorizontalScrollViewManager || !handle?.current) {
        return Promise.resolve();
      }

      return HorizontalScrollViewManager.disableMaintainVisibleContentPosition(
        handle.current
      );
    };
    ...
    return <ScrollView {...props} ref={refCallback} horizontal />;
  }
);
